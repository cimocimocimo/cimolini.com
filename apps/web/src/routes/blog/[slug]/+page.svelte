...
<div class="max-w-3xl mx-auto py-12 px-4">
	...
	<h1 class="text-4xl md:text-5xl font-extrabold text-slate-900 mb-4">{data.post.title}</h1>
	
	{#if data.post.publishedDate}
		<p class="text-slate-500 mb-8">{new Date(data.post.publishedDate).toLocaleDateString()}</p>
	{/if}

	<div class="prose prose-slate lg:prose-lg max-w-none mt-8">
